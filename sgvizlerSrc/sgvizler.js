...
var sgvizler = {
    ...
    example: {},
    go: function () {
        sgvizler.homefolder = $("#" + sgvizler.html.script).length ? $("#" + sgvizler.html.script).attr("src").replace(/sgvizler\.js$/, "") : "", $.ajax(sgvizler.homefolder + "sgvizler.visualization.js", {
            dataType: "script",
            async: !1
        }), $("head").append('<link rel="stylesheet" href="' + sgvizler.homefolder + 'sgvizler.visualization.css" type="text/css" />'), $.extend(sgvizler.queryOptionDefaults, sgvizler.queryOptions), $.extend(sgvizler.chartOptionDefaults, sgvizler.chartOptions), google.load("visualization", "1.0", {
            packages: ["annotatedtimeline", "corechart", "gauge", "geomap", "imagesparkline", "map", "orgchart", "table", "motionchart", "treemap"]
        }), google.setOnLoadCallback(function () {
            sgvizler.initGoogleObjects(), $.merge(sgvizler.chartTypes, sgvizler.GChartTypes);
            for (var a in sgvizler.visualization) sgvizler.util.registerFunction({
                id: sgvizler.visualization[a].prototype.id,
    ...
    parser: {
        ...
        SparqlXML2GoogleJSON: function (a) {
            ...
            return $(e).each(function () {
                for (var e = 0; e < b.length; e++) {
                    ...
                    if (h.length && $(h).first().children().first() !== "undefined" && $(h).first().children().first().firstChild !== null) {
                        var i = $(h).first().children().first()[0],
                            j = i.nodeName,
                            k = $(i).first().text();
        ...
        SparqlJSON2GoogleJSON: function (a) {
            ...
            for (var g = 0; g < e.length; g++) {
                var h = 0,
                    i = null,
                    j = null;
                while (typeof f[h][e[g]] == "undefined" && h + 1 < f.length) h++;
                typeof f[h][e[g]] != "undefined" && (i = f[h][e[g]].type, j = f[h][e[g]].datatype), d[g] = sgvizler.parser.getGoogleJsonDatatype(i, j), b[g] = {
                    id: e[g],
                    label: e[g],
                    type: d[g]
                };
        ...
        getGoogleJsonDatatype: function (a, b) {
            if (typeof a != "undefined" && (a === "typed-literal" || a === "literal")) {
                if (b === "http://www.w3.org/2001/XMLSchema#float" || b === "http://www.w3.org/2001/XMLSchema#double" || b === "http://www.w3.org/2001/XMLSchema#decimal" || b === "http://www.w3.org/2001/XMLSchema#int" || b === "http://www.w3.org/2001/XMLSchema#long" || b === "http://www.w3.org/2001/XMLSchema#integer") return "number";
